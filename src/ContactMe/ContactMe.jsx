...
const ContactMe = () => {
    return (
        <div id="contact-me">
            <h2>Get in Touch!</h2>
            <p><MailOutlineIcon /> <a href="mailto:pbmaloney@uwaterloo.ca">pbmaloney@uwaterloo.ca</a></p>
            <p><PhoneIphoneIcon /> (705) 768-3535</p>
            <div>
                ...
                <a href="https://devpost.com/PatrickBMaloney" >
                    <svg className="icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="38" height="38" viewBox="0 0 226 226" styles=" fill:#000000;">
                        <g fill="none" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" styles="mix-blend-mode: normal">
                            <path d="M0,226v-226h226v226z" fill="none"></path>
                            <g>
                                <path d="M165.08829,28.25h-104.17187l-47.49767,84.77825l48.71713,84.72175h102.94771l47.47883,-84.75z" fill="#00587a"></path>
